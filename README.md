...
Each test has a 3 second delay before scanning so that you have time to get into position after starting. To stop running a program due to a mistake, hit Ctrl-C.
